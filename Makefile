...
#    Updated: 2020/01/03 14:47:38 by jhallama         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PRINTFSRC = ft_printf.c format_specification_fields.c conversion_percentage.c conversion_c.c conversion_s.c conversion_p.c conversion_d.c choose_type.c
