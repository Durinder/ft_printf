...
#    Updated: 2020/01/08 11:47:52 by jhallama         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PRINTFSRC = ft_printf.c format_specification_fields.c conversion_percentage.c conversion_c.c conversion_s.c conversion_p.c conversion_di.c choose_type_di.c
